...
public interface GameRepository extends JpaRepository<GameEntity, Integer> {
	...
	@Query("Select g from GameEntity g, GamePlayerEntity gp where gp.player = ?1 and gp.game = g and "
			+ "g.ends < ?2 order by g.ends")
	public List<GameEntity> findLast10GamesForPlayer(PlayerEntity player, Date when);
